  ...
  return (
    <>
      <Drawer open={showBanner && !showPreferences} modal={false}>
        <DrawerContent className="h-[120px] mx-0 rounded-none border-t-2 border-gray-200">
          <div className="max-w-6xl mx-auto px-4 py-2">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 h-full">
