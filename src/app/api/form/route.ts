...
// ============================================================
// SFJ WEBSITE — app/api/form/route.ts
// Replaces your existing /api/form route.
// Just forwards the form data to your Express backend.
// No DB, no socket — backend handles all of that.
// ============================================================
...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/api/queries`, {
      method: "POST",
    ...
    return NextResponse.json(
      { success: false, message: "Could not reach server. Try again." },
      { status: 502 },
    );
  }
}
