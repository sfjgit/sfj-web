...
const Impact = () => {
  ...
  const technologyDistribution = [
    { domain: "Programming & Mobile Development", learners: 8000, percentage: 23 },
    ...
    { domain: "Generative AI & Machine Learning", learners: 4000, percentage: 11 },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Transforming careers and organizations through data-driven training excellence
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">35,000 learners across diverse technology domains</p>
          </div>
            ...
            {technologyDistribution.map((tech, index) => (
              <Card key={index} className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-lg font-semibold text-gray-900">{tech.domain}</h3>
                  <span className="text-2xl font-bold text-blue-600">{tech.learners.toLocaleString()}</span>
                </div>
                ...
                <p className="text-sm text-gray-600 mt-2">{tech.percentage}% of total training volume</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">40,000 total learners through strategic government collaborations</p>
          </div>
              ...
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-sm text-gray-600">learners trained</span>
                  </div>
                </CardHeader>
                <CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8">
              20,000 learners trained across banking, financial services, and insurance sectors
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 text-center">
              <div className="text-2xl font-bold text-blue-600 mb-2">Retail Banking</div>
              <p className="text-gray-600">Core banking operations and customer relationship management</p>
            </Card>
            <Card className="p-6 text-center">
              <div className="text-2xl font-bold text-purple-600 mb-2">Strategic Roles</div>
              <p className="text-gray-600">Risk management, compliance, and treasury operations</p>
            </Card>
            <Card className="p-6 text-center">
              <div className="text-2xl font-bold text-green-600 mb-2">Digital Banking</div>
              <p className="text-gray-600">Fintech development and digital platform innovation</p>
            </Card>
          </div>
        </div>
      </section>
