...
interface IndustryImpactItem {
  ...
  contribution: string;
  icon: LucideIcon;
  color?: string; // kept for compatibility; not used in the clean layout
  stats?: string;
}
    ...
    <section className="border-t border-gray-200 bg-white">
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24">
        <SectionIntro
          ...
          title="Empowering industries, enabling growth"
          subtitle="Our CSR initiatives drive meaningful change across diverse sectors through strategic partnerships and innovative solutions."
        />
