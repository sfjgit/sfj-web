          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                ...
                Government of India&#39;s Skill India mission. Through our
                robust training programs and partnerships, we are equipping
                individuals with the knowledge and practical skills demanded by
