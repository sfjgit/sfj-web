  ...
  const blogPosts = [
    {
      ...
      image: "/blog/1.jpg",
      description:
        "Many organizations are struggling with the digital transformation efforts that they have begun...",
      author: "Gorden Haff",
    ...
    },
    {
      ...
      image: "/blog/2.jpg",
      description:
        "The hiring landscape is constantly changing. At the same time, a range of external factors are impacting...",
    ...
    },
    {
      ...
      image: "/blog/3.jpg",
      description:
        "Staffing and recruitment firms that embrace automation have a 64% higher fill rate, submit 33% more candidates...",
    ...
    },
    {
      ...
      image: "/blog/4.jpg",
      description:
        "As businesses and organizations look towards the future with optimism, hoping for normalcy to return soon...",
      author: "Manav Seth",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Stay updated with the latest trends in technology, workforce
